...
export const WEBHOOK_DEPOSIT_URL = process.env.WEBHOOK_DEPOSIT_URL;

export const UPDATE_BALANCE_WITHDRAW_CANCELED_URL = process.env.UPDATE_BALANCE_WITHDRAW_CANCELED_URL;
