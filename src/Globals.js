...
class Globals{
    ...
    async connect(){
        ...
        await this.main_db.connect(`${MONGO_CONNECTION_STRING}/main`, {useMongoClient : true});
        this.main_db.Promise = bluebird;
        // Ecosystem DB
        this.ecosystem_db = new Mongoose();
        await this.ecosystem_db.connect(`${MONGO_CONNECTION_STRING}/ecosystem`, {useMongoClient : true})
